...
<title>The Atlanta Dekalb International Training Center (ATLANTA DITC) - Atlanta GA - The Living Legacy of the 1996 Atlanta Olympic Games - News &amp; Events - DITC Newsletters</title>
...
<div id="content">
	<div class="body-header">
		<img src="<?=homepath?>images/headerIMG-newsletters.jpg" width="500" height="153" border="0" alt="News &amp; Events" style="border-bottom: 2px solid #fff;"/>
	</div>
	<div style="clear: both"></div>
	
	<div class="body-section-title"><!--<h3>NEWSLETTERS</h3>--></div>
	
	<div class="pad15"><!-- START main body content -->
	
	<h4 class="italic red-text">Downloadable newsletters coming soon!</h4>
