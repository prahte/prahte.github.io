...
<div id="content">
	...
	<h4 class="blue-text">ANOC 5th General Assembly</h4>
	
	<dl class="inline-imagecnt-right">
	<dt><img src="<?=homepath?>news-events/articles/photos/anoc-fullsize.jpg" width="175" height="131" class="p-border" alt="" /></dt>
	<dd>The ANOC 5th General Assembly</dd>
	</dl>
	 
	<p><span class="bold">Seoul, KOREA</span> (April 1-5, 2006) &mdash; DITC was officially invited by ANOCA to attend the ANOC General Assembly. Five
	representatives from the DITC were in Seoul: Marc Daniel GUTEKUNST, Amadou DIA BA, Jean-Claude SORGE, Josh HENSON, and Charlie BATTLE.</p>
	...
	*/
	...
	<div id="flickr_badge_wrapper">
		<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=10&display=latest&size=s&layout=x&source=user_set&user=12628849%40N00&set=72157594385255540&context=in%2Fset-72157594385255540%2F"></script>
	</div>
