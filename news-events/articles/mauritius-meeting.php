...
<div id="content">
	...
	<h4 class="blue-text">Mauritius Pan African Meeting</h4>
	
	<dl class="inline-imagecnt-right">
	<dt><img src="<?=homepath?>news-events/articles/photos/mauritius-fullsize.jpg" width="175" height="131" class="p-border" alt="" /></dt>
	<dd>Mauritius Pan African Meeting</dd>
	</dl>
	 
	<p><span class="bold">Reduit, MAURITIUS</span> (April 8, 2006) &mdash; Jean-Claude SORGE and Marc Daniel GUTEKUNST attended the meeting. Both also
	met with Michael GLOVER to discuss the African Athletics Championships to be held in Mauritius August 9-13, 2006.</p>
	...
	*/
	...
	<div id="flickr_badge_wrapper">
		<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=10&display=latest&size=s&layout=x&source=user_set&user=12628849%40N00&set=72157594385338452&context=in%2Fset-72157594385338452%2F"></script>
	</div>
