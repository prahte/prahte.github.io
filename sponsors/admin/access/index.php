...
<div id="content" class="">
	...
	<div class="body-header">
		<img src="<?=constant('homepath')?>images/headerIMG-sponsoraccess.jpg" width="500" height="153" border="0" alt="Pentathlon" style="border-bottom: 2px solid #fff;"/>
	</div>
	...
	<h2 class="blue-text">Welcome, <?=intl_clean($userInfo[0]['fname'],0,1)?> <?=intl_clean($userInfo[0]['lname'],0,1)?>.</h2>
	
	<p>Your <strong>ATLANTA 1996 Affiliations</strong> are listed below. Click on the Affiliation name to access associated documents. 
	...
	<? if($userInfo[0]['photo'] != '') { ?>
	<img src="<?=homepath?>admin/access/assets/photos/<?=$userInfo[0]['photo']?>" width="50" class="p-border" />
	<? } ?>
	...
	<!--<form action="<?=homepath?>sports/admin/access/members/index.php?uID=<?=$userInfo[0]['id']?>" method="post" class="p-border bottom-buffer gray-bkgd-fade clear-float" />
