...
<div id="content" class="">
	...
	<div class="body-header">
		<img src="<?=homepath?>images/headerIMG-sponsoraccess.jpg" width="500" height="153" border="0" alt="" style="border-bottom: 2px solid #fff;"/>
	</div>
	...
	<p><a href="../index.php">Sponsor Access Home</a> | Documents</p>
	
	<h2 class="blue-text">Documents</h2>
