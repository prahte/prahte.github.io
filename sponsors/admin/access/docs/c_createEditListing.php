...
<p  class="clearfix <?=$class[1]?>"><label for="filelink" class="bold">Current File:</label> <span class="bold <?=$_SESSION['form']['type']?>" id="filelink"><a href="<?=homepath?>admin/access/assets/files/<?=$_SESSION['form']['file']?>"/><?=intl_clean($_SESSION['form']['doc_title'],1,0)?></a></span></p> 
<?php } ?>
<!-- FILE -->
...
<!-- AFFILIATIONS -->
<?php if($_SESSION['admin']['access_level'] > 2) { ?>
