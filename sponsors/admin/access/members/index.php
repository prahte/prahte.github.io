...
<div id="content" class="">
	...
	<div class="body-section-title align-right" id="sports"><h3><a href="<?=homepath?>sports/admin/logout.php">Log Out</a></h3></div>
	
	<div class="pad15"><!-- START main body content -->
	
	<p><a href="../index.php">Sponsor Access Home</a> | Member Information</p>
