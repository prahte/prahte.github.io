...
if(!empty($pw) && $pw[0]['access'] < 2) { $_SESSION['alert']['message'] .= 'Your account is no longer active. Please contact us for more information.<br />'; header("Location:index.php"); exit; }
