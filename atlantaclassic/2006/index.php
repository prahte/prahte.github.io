...
<div align="center">
  <table width="759" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"> <tr align="left" valign="top"> 
    ...
    </tr><tr><td colspan="3" id="bar"><p style="text-align:right; "><span class="fltlft"><a href="/index.php">Home</a></span><a href="mailto:msanford@dekalbclassic.us">Contact Us</a></p></td>
	</tr>
	...
	<td align="left" valign="top" width="580" style="border: 1px solid #fff;" >
				...
				Photo Gallery<br>
				<span class="style2">May 27-28, 2006<br>
				DeKalb International Prep Classic (DIPC)</span>
				</p>
				<p class="galleryLink"><a href="index.php?gallery=1">Gallery 1</a> <a href="index.php?gallery=2">Gallery 2</a> <a href="index.php?gallery=3">Gallery 3</a> <a href="index.php?gallery=4">Gallery 4</a>
				<p class="galleryText">Click on a photo to view a larger version</p>
				<!--<p align="center" class="photocredit">Photos by Clif Sparkman</p>
				<p align="center" class="photocredit">&nbsp;Competition Day, May 28</p>-->
				...
				if(isset($_REQUEST['gallery']) && $_REQUEST['gallery'] != '') {
					if($_REQUEST['gallery'] == 1) { $grand_total = 24; $startCount = 0; }
					if($_REQUEST['gallery'] == 2) { $grand_total = 48; $startCount = 24; }
					if($_REQUEST['gallery'] == 3) { $grand_total = 72; $startCount = 48; }
					if($_REQUEST['gallery'] == 4) { $grand_total = count($files_array); $startCount = 71; }
				} else { $grand_total = 24; $startCount = 0; }
				...
				<?php if($cell_reset == 0) { echo("<tr>"); }?>
					<td>
						...
						<a href="images/<?=$files_array[$i]?>" rel="lightbox[DIPCphotos06]" title="The Dekalb International Prep Classic - May 27-28, 2006"><img src="images/<?=$files_array[$i]?>" width="<?=$width?>" height="<?=$height?>" alt="" border="0" /></a>
						<?php #echo("<br>".$total); ?>
