  ...
  <table width="759" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"> <tr align="left" valign="top"> 
    ...
    <td width="178" height="185" align="left" valign="top">
		  ...
		  <tr> 
				...
				Photo Gallery<br>
							<span class="style2">May 24, 2008<br>
				...
				<?php if($cell_reset == 0) { echo("<tr>"); }?>
					<td>
						...
						<a href="images/<?=$files_array[$i]?>" rel="lightbox[DIPCphotos07]" title="Atlanta DeKalb International Prep Classic (ATLANTA CLASSIC) - May 24, 2008"><img src="images/<?=$files_array[$i]?>" width="<?=$width?>" height="<?=$height?>" alt="" border="0" /></a>
						<?php #echo("<br>".$total); ?>
