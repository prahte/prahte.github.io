...
<div id="content">
	...
	<table border="0" cellspacing="0" cellpadding="0" class="merchandise" >
		...
		<tr>
			<td>
			<img src="images/ditc-bag.jpg" alt="DITC Canvas Bag" width="142" height="142" border="0" class="float-left t-border" />
	...
	<table border="0" cellspacing="0" cellpadding="0" class="merchandise" >
		...
		<tr>
			<td>
			<a href="#" onmouseover="MM_swapImage('backpack','','images/ditctunis-backpack-back.jpg',1)" onmouseout="MM_swapImgRestore()"><img src="images/ditctunis-backpack-front.jpg" alt="DITC Tunis Backpack" width="142" height="142" border="0" class="float-left t-border" id="backpack" /></a>
