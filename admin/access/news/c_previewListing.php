...
<div class="news-summary clearfix">
	...
	<img src="/news-events/articles/photos/<?=$_SESSION['form']['thumb_photo']?>" width="90" alt="<?=$_SESSION['form']['title']?>" class="" />
	<?php } else { ?>
	<img src="/news-events/articles/photos/ditc-thmb-default.jpg" width="90" height="90" alt="<?=$_SESSION['form']['title']?>" class="" />
	<?php } ?>
...
<dl class="inline-imagecnt-right">
	...
	?>
	<a href="/news-events/articles/photos/<?=$_SESSION['form']['photo_1']?>" class="lightbox"  title="<?=strip_tags(intl_clean($_SESSION['form']['caption_1'],1,0));?>">
	<img src="/news-events/articles/photos/<?=$_SESSION['form']['photo_1']?>" width="<?=$width?>" height="<?=$height?>" class="p-border" alt="<?=strip_tags(intl_clean($_SESSION['form']['caption_1'],1,0));?>" />
	</a>
	</dt>
	<dd>
	<?php
...
<dl class="inline-imagecnt-left">
	...
	if ($w != 175) { $width = 175; $height = round(($h * 175) / $w); } else { $width = $w; $height = $h; }
	?>
	<a href="/news-events/articles/photos/<?=$_SESSION['form']['photo_2']?>" class="lightbox"  title="<?=strip_tags(intl_clean($_SESSION['form']['caption_2'],1,0));?>">
	<img src="/news-events/articles/photos/<?=$_SESSION['form']['photo_2']?>" width="<?=$width?>" height="<?=$height?>" class="p-border" alt="<?=strip_tags(intl_clean($_SESSION['form']['caption_2'],1,0));?>" />
	</a>
	</dt>
	<dd>
	<?php
