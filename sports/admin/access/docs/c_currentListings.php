...
<h5 class="<?=$activeListings[$i]['type']?>"><a href="/admin/access/assets/files/<?=$activeListings[$i]['file']?>"><?=intl_clean($activeListings[$i]['doc_title'],0,1)?></a></h5>
<p>
...
?>
<a href="/sports/admin/access/members/index.php?uID=<?=$userInfo[0]['id']?>">
...
?>
<a href="/sports/admin/access/groups/index.php?gID=<?=$affil[$g]['id']?>"><?=intl_clean($affil[$g]['name'],0,1)?></a>
...
<h5 class="plus"><a href="/sports/admin/access/docs/index.php?n=1">Upload a New Document</a></h5>
<?php } ?>
