...
<div id="content">
	...
	<h3 class="blue-text">Meet the Athletes </h3>
	...
	<h5 class="red-text"><?=$team[0]['groupname']?></h5>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="teamListing">
		...
		?>
			<td>
				<?php
				if( $team[$i]['photo'] != '' ) {
					echo '<img src="'.homepath.'admin/access/assets/photos/'.$team[$i]['photo'].'" height="90" alt="'.intl_clean($team[$i]['fname'],0,0).' '.intl_clean($team[$i]['lname'],0,0).'" class="p-border" />';
				} else { 
					echo '<img src="'.homepath.'images/photoComingSoon.jpg" width="90" height="90" alt="'.intl_clean($team[$i]['fname'],0,0).' '.intl_clean($team[$i]['lname'],0,0).'" class="p-border" />';
				}
				?>
