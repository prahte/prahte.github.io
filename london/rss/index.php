...
<channel>
<title>London 2012 WUOC House Blog</title>
<link>http://ditc.us/london/</link>
<atom:link href="http://<? echo $_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF']; ?>" rel="self" type="application/rss+xml" />
<description>An ongoing report from the ATLANTA 1996 International Training Center during the London Games</description>
<language>en-us</language>
<copyright>Copyright <?=date('Y')?>, The ATLANTA 1996 International Training Center</copyright>
<webMaster>webmaster@ditc.us (ATLANTA 1996 Web Master)</webMaster>
...
<generator>ATLANTA 1996 International Training Center</generator>
...
<guid isPermaLink="true">http://ditc.us/london/?pID=<?=$posts[$i]['id']?></guid>
</item>
<?php } ?>
</channel>
</rss>