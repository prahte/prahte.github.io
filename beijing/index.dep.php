<?php
require('../includes/global/constants.php');
require(homepath.'includes/global/functions.php');
...
<?php include(homepath."includes/modules/head.beijing.php") ?>
<style type="text/css" media="screen">
#ATRswfBanner, #ATRBanner, #OlympicCongress, #handballRightLink, #competitions { display: none; }
</style>
...
<?php include(homepath."includes/modules/masthead.php") ?>

<?php include(homepath."includes/modules/top-nav.php") ?>

<div id="body-container">

<?php include(homepath."includes/modules/left-nav.php") ?>

<div id="content">
	<div class="body-header clearfix">
		<a href="/beijing"><img src="<?=homepath?>images/headerIMG-BeijingBlog.jpg" width="500" height="153" border="0" alt="Beijing Olympics Blog" style="border-bottom: 2px solid #fff;"/></a>
	</div>
	
	<div class="body-section-title"><h3 style="text-align: right;">&nbsp;<a href="rss/" title="RSS Feed of the ATLANTA DITC Beijing Blog"><img src="<?=homepath?>images/icon-rss-large.gif" alt="RSS Feed of the ATLANTA DITC Beijing Blog" width="12" height="12" /></a></h3></div>
	
	<div id="blogBody" class="pad20"><!-- START main body content -->
	
	<h3 id="latestPostHeader"><em>The Latest Post</em></h3>
	...
	<ul id="blogPosts">
		<li>
			...
			<?=intl_clean($posts[0]['post_content'],0,1)?>
			</div>
			<?php
				if($posts[0]['asset_flag'] == 1) {
					...
					for($a=0; $a<mysql_num_rows($assetsResult); $a++) {
						...
						echo '<li><a href="/news-events/articles/photos/'.$asset[$a]['file'].'" rel="lightbox[photos]" title="'.intl_clean($asset[$a]['caption'],1,1).'"><img src="/news-events/articles/photos/'.$asset[$a]['thumbnail']."\" alt=\"\" /></a></li>\n";
					}
					echo "</ul>\n";
				}
...
<?php include(homepath."includes/modules/right-sidebar.php") ?>		
<div class="body-clear"></div>		
</div><!-- END body-container -->
</div><!-- END main-container -->
<?php include(homepath."includes/modules/footer.php") ?>
